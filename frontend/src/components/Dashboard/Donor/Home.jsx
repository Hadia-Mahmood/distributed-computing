...
export const Home = () => {
  ...
  const totalComplaints = complaintData?.totalComplaints || 3;
  const complaintsResolved = complaintData?.validComplaints || 1;
  const totalWasteRecycled = wasteData?.totalWasteReceived || 1000;
  const recyclingPercentage = wasteData?.avgRecyclablePercentage || 4;
